--[[ 
	...
	and walls until it passes a left or right boudary of the screen,
...
--[[ 
    ...
    on wether their rectangles overlap. 
]]
function Ball:collides(paddle)
    ...
    -- then checkk to ee if the bottom edge of either is higher than the 
    -- edge of the other
